...
function generateJwtToken($userId, $username) {
    ...
    $tokenPayload = array(
        ...
        "userId" => $userId,
        "username" => $username,
        "userRole" => "user", // Hardcoded user role as "user"
    );
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, username, password FROM users WHERE username = '$login' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        setcookie("jwt", $token, time() + 3600, "/"); // Replace with your desired cookie settings
...
<div class="login-container">
    ...
    <a href="register.php">
        <button class="form-group button-signup">Зарегистрироваться</button>
    </a>
